...
from ts_benchmark.baselines.ElasTST.models.ElasTST import ElasTST as ElasTSTmodel
...
DEFAULT_HYPER_PARAMS = {
    ...
    "H_order": 2,
    "individual": False,
    "kwargs": {"target_dim": 64, "context_length": 96, "prediction_length": 720, "freq": "d", "lags_list": [24, 48]},
}
...
class ElasTST(ModelBase):
    def __init__(self, **kwargs):
        super().__init__()
        self.config = ElasTSTConfig(**kwargs)
    ...
    def forecast_fit(
        ...
        self.model = ElasTSTmodel(self.config)
